...
| [tray-utility-customizer/](tray-utility-customizer/) | v0.4, ready for live test | Arranges detected Windows tray utilities into a configurable row, column, or smart grid |
