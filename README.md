...
|--------|--------|-------------|
| [omnibutton-customizer/](omnibutton-customizer/) | v1.0, ready for live testing | Per-item layout, visibility, color, size, font, opacity, and position control for the Windows 11 OmniButton |
